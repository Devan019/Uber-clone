...
const RideNotification = ({setShowRideNotification , setShowConformRide, name, ride}) => {
        ...
        <div>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='mt-5 w-full '>
                    <button onClick={() => {
                        // props.setConfirmRideNotificationPanel(true)
                        // props.confirmRide()
                        setShowConformRide(true)

                    }} className=' bg-green-600 w-full text-white font-semibold p-2 px-10 rounded-lg'>Accept</button>

                    <button onClick={() => {
                        // props.setRideNotificationPanel(false)
